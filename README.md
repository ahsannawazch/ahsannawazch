...
- **AI/ML Libraries:** PyTorch, Hugging Face Transformers, unsloth, BitsAndBytes, VLLM, Scikit learn, Numpy, pandas, plotly, seaborn and matplotlib.
...
- **Kaggle:**
  - Intro to Machine Learning (Jan 2022)
  - Pandas (Jan 2022)
- **Coursera:**
  - Neural Networks and Deep Learning (Nov 2021)
